...
function getFallbackCitiesByCountryId(countryId: string): City[] {
  const fallbackCities: City[] = [
    ...
    { id: 2, name: "Chiang Mai", country: 1, image: "https://images.unsplash.com/photo-1596622897385-0086202d383d?q=80&w=2532&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", featured: true, rank: 3, mood: ["cultural", "peaceful", "affordable", "temples"], description: "A cultural hub in northern Thailand, famous for its ancient temples, night markets, and laid-back mountain atmosphere.", overallRating: 85, costRating: 90, safetyRating: 85, funRating: 82, foodRating: 88 },
