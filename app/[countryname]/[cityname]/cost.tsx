          ...
          <div className="max-w-6xl">
            ...
            <div className="mb-8">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                {displayCityName} Travel Cost Guide - How expensive is {displayCityName}?
              </h1>
              <p className="text-gray-600">
                Get a personalized travel cost breakdown for your trip to {displayCityName}, {displayCountryName}
              </p>
            </div>
