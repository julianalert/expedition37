          ...
          <div className="max-w-6xl">
            ...
            <div className="mb-8">
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                Itinerary for {displayCityName}
              </h1>
              <p className="text-gray-600">
                Create a personalized travel itinerary for your trip to {displayCityName}, {displayCountryName}
              </p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="e.g., Visit museums, try local food, explore historic sites, enjoy nightlife..."
                    value={interests}
