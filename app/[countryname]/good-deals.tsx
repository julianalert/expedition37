...
export default function GoodDeals({ countryName }: GoodDealsProps) {
        ...
        <div className="pt-4 pb-8 md:pt-4 md:pb-16">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">💡 Money-saving tips for {country.name}</h3>
