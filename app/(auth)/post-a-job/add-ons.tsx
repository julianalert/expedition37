  ...
  return (
    <div className="py-6">
      ...
      <div className="space-y-4">
        <button
          className={`w-full text-left py-3 px-4 border rounded-sm ${stick ? 'border-indigo-500 ring-2 ring-indigo-200' : 'border-gray-200'
            }`}
          onClick={(e) => {
            e.preventDefault();
            setStick(!stick);
        ...
        <button
          className={`w-full text-left py-3 px-4 border rounded-sm ${highlight ? 'border-indigo-500 ring-2 ring-indigo-200' : 'border-gray-200'
            }`}
          onClick={(e) => {
            e.preventDefault();
      ...
      <div className="mt-6">
        <button className="btn w-full text-white bg-indigo-500 hover:bg-indigo-600 shadow-xs">Pay Now - $349</button>
      </div>
      <div className="mt-4">
